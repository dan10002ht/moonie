...
- [ ] **Giai đoạn 5 — Admin UI — BƯỚC TIẾP THEO** (dashboard + quản lý leads/orders/products/customers bằng Next.js + shadcn/ui theo design tokens Mooni; đăng nhập /admin/login; áp low_stock status nếu làm)
